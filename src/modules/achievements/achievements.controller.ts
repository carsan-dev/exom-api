...
export class AchievementsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Listado de logros obtenido correctamente',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Logros desbloqueados del usuario obtenidos correctamente',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Catálogo de logros obtenido correctamente',
  })
  @ApiResponse({ status: 403, description: 'Acceso restringido a clientes' })
  findCatalog() {
  ...
  @Roles(Role.ADMIN, Role.SUPER_ADMIN)
  @ApiOperation({
    summary: 'Get achievement detail with users who unlocked it',
  })
  @ApiResponse({
    status: 200,
    description: 'Detalle del logro obtenido correctamente',
  })
  ...
  @ApiOperation({
    summary:
      'Recompute automatic achievements for visible clients or a selected batch',
  })
  @ApiResponse({
    status: 200,
    description: 'Recálculo histórico ejecutado correctamente',
  })
  @ApiResponse({
    status: 202,
    description: 'Solicitud de aprobación creada (solo ADMIN)',
