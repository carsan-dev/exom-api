...
export type NotificationTemplateScheduleKind =
  | 'daily'
  | 'weekly'
  | 'meal_daily';
...
export const NOTIFICATION_TEMPLATE_VARIABLE_HELP: Record<string, string> = {
  ...
  planSummary:
    'Resumen del plan asignado, por ejemplo "un entrenamiento" o "2 días de dieta".',
...
> = {
  ...
  challenge_assigned: {
    ...
    description: 'Se envía al cliente cuando recibe un reto nuevo.',
  },
  challenge_completed: {
    type: 'event',
    label: 'Al completar un reto',
    description: 'Se envía al cliente cuando el reto pasa a completado.',
  },
  streak_milestone: {
    type: 'event',
    label: 'Al alcanzar un hito de racha',
    description: 'Se envía al llegar a 7, 30, 100 o 365 días de racha.',
  },
  admin_client_assigned: {
    type: 'event',
    label: 'Al asignar cliente a admin',
    description: 'Se envía al admin cuando recibe un cliente asignado.',
  },
  admin_feedback_submitted: {
    type: 'event',
    label: 'Al subir feedback',
    description: 'Se envía al admin cuando un cliente sube un feedback nuevo.',
  },
  admin_weekly_summary: {
    type: 'schedule',
